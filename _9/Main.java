...
public class Main {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1:");
        int porridgeHeatInCentigrade = 60;
    ...
    private static void exercise3() {
        ...
        if (ourDouble > 2.5) {
            System.out.println("Greater than"); // condizione rispettata
        } else {
            ourDouble++;
            if (ourDouble < 2.5) {
                System.out.println("Still less than"); // testato con ourDouble = 0.5;
            } else {
                System.out.println("Now greater than"); // testato con ourDouble = 1.5;
            }
        }
    }
