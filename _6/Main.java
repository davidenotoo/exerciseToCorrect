...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("La radice di " + value + " è: " + valueSquareRoot);
    }
    ...
    private static void exercise4Bonus() {
        ...
        // basta poggiare il puntatore del mouse sul metodo per scoprirlo;

        // Math.ceil() arrotonda una variabile per eccesso;
        System.out.println(ourValue + " after using ceiling=" + Math.ceil(ourValue));

        // Math.floor() arrotonda una variabile per difetto;
